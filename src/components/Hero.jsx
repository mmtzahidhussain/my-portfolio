        ...
        >
          <div className="relative">
            ...
            <motion.a
              ...
              className="absolute -bottom-6 -right-2 z-20 px-3.5 py-2 rounded-2xl text-xs font-bold shadow-xl bg-gray-900/95 border border-emerald-400/50 backdrop-blur-md text-white flex items-center gap-2 group cursor-pointer"
            >
              <div className="p-1.5 rounded-xl bg-emerald-500 text-gray-950 shadow-md shadow-emerald-500/30 group-hover:scale-110 transition-transform">
